export const PRESETS = [
  ...
  { id:'ep',     name:'Electric Piano',        osc:'triangle', env:{a:0.01,d:0.35,s:0.55,r:0.5 }, filt:{cut:3800,q:0.7}, fx:{rev:0.3, delay:0.12} },
  ...
  { id:'organ',  name:'Organ',                 osc:'square',   env:{a:0.0, d:0.1, s:0.8,r:0.15},filt:{cut:6500,q:0.6}, fx:{rev:0.18,delay:0.08} },
  { id:'strings',name:'Strings',               osc:'sawtooth', env:{a:0.15,d:0.6, s:0.7,r:0.9 }, filt:{cut:3400,q:0.7}, fx:{rev:0.35,delay:0.10} },
